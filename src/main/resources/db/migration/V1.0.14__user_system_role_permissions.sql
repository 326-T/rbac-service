...
(
    ...
    CONSTRAINT rbac_user_system_role_permissions_created_by_foreign FOREIGN KEY (created_by) REFERENCES rbac_users (id) ON DELETE CASCADE,
    CONSTRAINT rbac_user_system_role_permissions_updated_by_foreign FOREIGN KEY (updated_by) REFERENCES rbac_users (id) ON DELETE CASCADE
);