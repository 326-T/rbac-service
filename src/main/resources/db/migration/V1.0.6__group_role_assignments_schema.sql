...
(
    ...
    CONSTRAINT group_role_assignments_namespace_id_user_group_id_role_id_unique UNIQUE (namespace_id, user_group_id, role_id),
    CONSTRAINT group_role_assignments_namespace_id_foreign FOREIGN KEY (namespace_id) REFERENCES rbac_namespaces (id) ON DELETE CASCADE,
